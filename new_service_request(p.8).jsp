...
.row{
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">요청자</div>
      <div class="col-md-6">빈칸</div>
    </div>
    <div class="row">
      <div class="col-md-6">접수경로</div>
      <div class="col-md-6">빈칸</div>
    </div>
    <div class="row">
      <div class="col-md-3">문제범위</div>
      <div class="col-md-3">빈칸</div>
	  <div class="col-md-3">긴급도</div>
      <div class="col-md-3">빈칸</div>
    </div>
	<div class="row">
