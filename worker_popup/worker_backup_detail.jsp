...
<body>
	...
	<form class="form-horizontal">
  		<div class="form-group">
    		...
    		<div class="col-sm-8">
      			<input type="text" class="form-control" id="inputTarget" placeholder="대상" readonly>
    		</div>
  		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="inputEquip" placeholder="장비" readonly>
			</div>
		</div>
		<div class="form-group">
			<label for="inputCapacity" class="col-sm-2 control-label">용량</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" id="inputCapacity" placeholder="용량" readonly>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<textarea name = "method" class="form-control" rows="5" placeholder="방식"  readonly></textarea>
			</div>
		</div>
		<div class="form-group">
			<label for="inputNote" class="col-sm-2 control-label">비고</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" id="inputNote" placeholder="비고" readonly>
			</div>
		</div>
  		<div class="form-group">
