...
<form>
    ...
    <td><input name="target" type="textbox" style="width: 100%;" readonly></input></td>
    </tr>
    <tr>
    <td>일시</td>
    <td><input name="date" type="date" style="width: 100%;" readonly></td>
    <!-- 달력 표시 -->
    </tr>
    <tr>
    <td>장비</td>
    <td><input name="equip" type="textbox" style="width: 100%;" readonly></td>
    </tr>
    <tr>
    <td>용량</td>
    <td><input name="size" type="textbox" style="width: 100%;" readonly></td>
    </tr>
    <tr>
    <td>시간</td>
