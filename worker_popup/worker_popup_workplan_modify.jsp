...
<form>
    ...
    <td><input name="type" type="textbox" style="width: 100%;"></input></td>
    </tr>
    <tr>
    <td>일시</td>
    <td><input name="date" type="date" style="width: 100%;" value="2000-01-01"></td>
    <!-- 달력 표시 -->
    </tr>
    <tr>
    <td>작업자</td>
    ...
    <tr>
    <td>세부내역</td>
    <td><input name="detail" type="textbox" style="width: 100%;"></td>
    </tr>
    <td>비고</td>
