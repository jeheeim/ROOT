...
<body>
	...
	<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="inputTarget" placeholder="복구대상" readonly>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<textarea name = "method" class="form-control" rows="5" placeholder="복구방법" readonly></textarea>
			</div>
		</div>
		<div class="form-group">
