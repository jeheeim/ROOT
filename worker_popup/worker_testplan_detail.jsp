...
<body>
	...
	<form class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" class="form-control" id="inputWorker" placeholder="담당자" readonly>
			</div>
		</div>
		<div class="form-group">
			<label for="inputTestcase" class="col-sm-2 control-label">테스트 케이스</label>
			<div class="col-sm-8">
				<textarea name = "testcase" class="form-control" rows="5" placeholder="테스트 케이스" readonly></textarea>
			</div>
		</div>
		<div class="form-group">
			<label for="inputresult" class="col-sm-2 control-label">예상결과</label>
			<div class="col-sm-8">
				<textarea name = "result" class="form-control" rows="4" placeholder="예상결과" readonly></textarea>
			</div>
		</div>
		<div class="form-group">
			<label for="inputNote" class="col-sm-2 control-label">비고</label>
			<div class="col-sm-8">
				<textarea name = "note" class="form-control" rows="3" placeholder="비고" readonly></textarea>
			</div>
		</div>
  		<div class="form-group">
